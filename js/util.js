...
class Toast {
  ...
  showToast() {
    ...
    if (this.icon != "") {
      toast.innerHTML += `<img loading="lazy" alt="icon" src="${this.icon}" class="toast-icon" alt="Toast Popup Icon">`;
    }
...
class Popup {
  ...
  showPopup() {
    ...
    if (this.icon) {
      $(`<img loading="lazy" alt='Popup Icon' src="${this.icon}" class="popup-icon">`).appendTo(toast);
    }
    if (this.title) {
